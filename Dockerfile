...
RUN git clone https://github.com/scipr-lab/libsnark.git && git checkout 477c9dfd07b280e42369f82f89c08416319e24ae && cd libsnark && git submodule update --init --recursive && cd .. && \
